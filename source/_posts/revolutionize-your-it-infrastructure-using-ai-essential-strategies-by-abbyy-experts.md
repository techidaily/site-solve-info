...
date: 2024-09-10T23:25:08.057Z
updated: 2024-09-14T23:00:05.278Z
categories:
  - abbyy
...
This use case isn’t just a proof point for the value of [ABBYY OCR](https://tools.techidaily.com/abbyy/products/) in processing large volumes of unstructured documents, but also a testament to the strength and efficacy of the global company’s automation fabric. 
...
Each stage incorporates a combination of AI-enabled technologies and platforms: 

* Business process management and mining (BPMM)
* Intelligent document processing and archiving (IDPA – ABBYY is here)
* Low-code / no-code
* Workflow automation (WFA)
* Robotic process automation (RPA)
* Backend automation (BEA)

This digital playbook has supported multiple digitization initiatives for the organization and will continue to do so in the future as they look towards additional application integrations with automation tools. For example, they’ve also automated invoice processing in their [accounts payable](https://tools.techidaily.com/abbyy/products/) workflow using ABBYY IDP, yielding a 53% straight-through processing rate. 
